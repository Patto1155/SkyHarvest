...
| G6 | **Hotbar mismatch**: HUD renders 6 slots, only keys 1–4 wired to 4 tools; slots 5–6 dead | spec §9 hotbar | `Bootstrap.cs` (6 slots), `ToolSystem.cs` (4 tools) | OPEN — decide: wire 5–6 (seeds?) or shrink HUD to 4 |
